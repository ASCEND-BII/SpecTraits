  ...
  moduleServer(export, function(input, output, session) {
    ...
    output$download_all <- downloadHandler(
      ...
      content = function(zipfile) {
        ...
        build_import_figure()$spectra_figure
        dev.off()
        ...
        build_import_figure()$trait_figure
        dev.off()
        ...
        split_action_figure()$spectra_split_figure
        dev.off()
        ...
        split_action_figure()$trait_split_figure
        dev.off()
        ...
        coefficients_figure()$coefficients
        dev.off()
